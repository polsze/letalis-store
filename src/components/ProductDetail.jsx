...
const ProductDetail = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-28 mb-10 border">
      {/* Header */}
      <div className="text-sm text-gray-500 mb-4">
        Inicio &gt; Categoría &gt; {product.category} &gt; {product.name}
      </div>

      {/* Main content */}
      <div className="flex flex-col md:flex-row gap-8 sm:flex-wrap ">
        {/* Image section */}
        ...
        <div className="flex-1">
          ...
          <button className="w-full bg-gray-200 text-black py-3 rounded-md hover:bg-gray-300 transition flex flex-row items-center justify-evenly xs:flex-col md:px-2">
            Canal Ventas 2
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="200"
      ...
      <div className="mt-10">
        ...
        <div className="flex items-center gap-4 overflow-x-auto">
          {recommendedProducts.map((item) => (
            <div
              key={item.id}
              className="w-[200px] h-[400px] flex-shrink-0 bg-white shadow-md rounded-lg p-4"
            >
              <img
                src={item.image}
                alt={item.name}
              ...
              {/* See More Button */}
              <Link
                to={`/productos/${item.category}/${item.link}/${item.id}`}
                className="flex flex-row w-28 h-10 mt-4 bg-orange-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition"
              >
