const ServicesPage = () => {
  return (
    <div className="w-full mx-auto bg-serviciosBg bg-no-repeat bg-cover pb-10">
      <div className="container mx-auto pt-40 xxl:px-6 ">
        <h1 className="text-4xl font-semibold text-white text-start mb-8 bg-gradient-to-r from-yellow-300 via-white to-gray-500 inline-block text-transparent bg-clip-text xxxl:ml-10 sm:text-3xl">
          <span className="my-auto border border-azul mr-3"></span>Servicio
          Técnico y{" "}
          <span className=" bg-green-600 rounded px-2 text-white sm:text-3xl sm:text-center sm:px-0 sm:ml-3">
            Reparación
          </span>
        </h1>
        <p className="text-lg text-white text-center mb-16 max-w-lg xxxl:pl-10 sm:-ml-10">
          En LETALIS STORE, no solo ofrecemos productos, sino también servicios
          de reparación para que tu equipo siempre esté en su mejor estado.
          ¡Confía en nuestros expertos para mantener tus dispositivos
          funcionando!
        </p>
        <div className="flex flex-row gap-10 lg:gap-4 sm:flex-col">
          {/* Reparación de PCs y Notebooks */}
          <div className=" flex flex-col items-center shadow-lg rounded-lg overflow-hidden ">
            <img
              src="/img/Imagen de Servicios, Reparación PC Y Notebooks de Letalis Store.webp"
              alt="Imagen de Servicios, Reparación PC Y Notebooks de Letalis Store"
            ...
            <div className="p-6 xs:p-0">
              <h2 className="text-2xl font-semibold text-white  mb-4 lg:text-xl lg:px-1 xs:px-2 xs:mb-1 xs:mt-2 xs:text-center">
                Reparación de PCs y Notebooks
              </h2>
              <p className="text-white mb-4 lg:px-1 xs:px-6">
                Realizamos diagnósticos y reparaciones de hardware y software
                para PCs y notebooks. Ya sea que necesites un cambio de
                pantalla, limpieza interna o actualización de componentes,
                nuestro equipo te ayudará.
              </p>
              <button className="w-full bg-azul text-white text-xl uppercase py-3 rounded-md transition duration-300 hover:bg-yellow-600 mb-4 flex flex-row items-center justify-evenly sm:text-sm">
          ...
          <div className="flex flex-col items-center shadow-lg rounded-lg overflow-hidden">
            <img
              src="/img/Imagen de Servicios, Reparación Celulares y Tablets de Letalis Store.webp"
              alt="Imagen de Servicios, Reparación Celulares y Tablets de Letalis Store"
              className="rounded-lg"
              width={500}
              height={500}
              loading="lazy"
            />
            <div className="p-6">
              <h2 className="text-2xl font-semibold text-black mb-4 lg:px-1 xs:px-2 xs:mb-1 xs:mt-2 xs:text-center">
                Reparación de Celulares
              </h2>
              <p className="text-black mb-4 lg:px-1 xs:px-6">
                ¿Tu celular está fallando? Ofrecemos reparaciones rápidas y
                eficientes para solucionar problemas de pantalla rota, problemas
                de batería, daños por agua y más. ¡Deja que nuestros expertos lo
                arreglen por ti!
              </p>
              <button className="w-full bg-azul text-white uppercase text-xl py-3 rounded-md transition duration-300  mb-4 flex flex-row items-center justify-evenly hover:bg-yellow-600 xxl:items-center xxl:justify-center sm:text-sm ">
                Chateá con un representante
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="200"
